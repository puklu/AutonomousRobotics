...
(cl:defmethod cl:initialize-instance :after ((m <multiplier-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'multiplier-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_package1-srv:<multiplier-request> is deprecated: use my_package1-srv:multiplier-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <multiplier-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_package1-srv:a-val is deprecated.  Use my_package1-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <multiplier-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_package1-srv:b-val is deprecated.  Use my_package1-srv:b instead.")
  (b m))
...
(cl:defmethod cl:initialize-instance :after ((m <multiplier-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'multiplier-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_package1-srv:<multiplier-response> is deprecated: use my_package1-srv:multiplier-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <multiplier-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_package1-srv:result-val is deprecated.  Use my_package1-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<multiplier-response>)))
  ...
  "my_package1/multiplierResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'multiplier-response)))
  "Returns string type for a service object of type 'multiplier-response"
  "my_package1/multiplierResponse")
