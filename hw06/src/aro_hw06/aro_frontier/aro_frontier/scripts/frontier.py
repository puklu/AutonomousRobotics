...
from aro_frontier import utils
import itertools
...
class FrontierExplorer():
    ...
    def getRandomFrontier(self, request):
        ...
        pos = utils.gridToMapCoordinates(frontierCenter, self.grid_info)
    ...
    def getClosestFrontier(self, request):
        ...
        pos = utils.gridToMapCoordinates(closest_frontier, self.grid_info)
    ...
    def getRobotCoordinates(self):
        try:
            ...
            pos = utils.getRobotGridPosition(trans, self.grid_info)
