...
"""autogenerated by genpy from aro_msgs/FollowPathActionGoal.msg. Do not edit."""
import codecs
import sys
...
class FollowPathActionGoal(genpy.Message):
  _md5sum = "b70cb8a20911d6655fd530c4be08b894"
  _type = "aro_msgs/FollowPathActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','aro_msgs/FollowPathGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.goal is None:
        self.goal = aro_msgs.msg.FollowPathGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = aro_msgs.msg.FollowPathGoal()
